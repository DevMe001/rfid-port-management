...
const FooterMd = () => {
  ...
  return (
				<div className='hidden sm:flex col-start-1 -col-end-1 row-start-4 row-end-5 h-screen sm:h-[40vh] md:h-[60vh] lg:h-[40vh] overflow-y-auto'>
					<footer className='text-center md:text-left w-full flex flex-col md:flex-row  justify-around items-baseline flex-wrap  h-full py-6' style={{ background: `url(${BgFooter}) no-repeat`, backgroundSize: 'cover', width: '100%' }}>
